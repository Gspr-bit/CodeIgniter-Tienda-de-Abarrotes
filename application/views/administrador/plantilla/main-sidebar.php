        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/categoria/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Categoría</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/ciudad/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ciudad</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/cliente/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cliente</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/colonia/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Colonia</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/direccion/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dirección</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/empleado/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Empleados</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/nivel/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Nivel</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/pedido/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pedido</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/proveedor/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Proveedor</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/transportista/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Transportista</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url();?>index.php/usuario/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Usuario</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=base_url();?>pages/examples/faq.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>FAQ</p>
                </a>
              </li>
