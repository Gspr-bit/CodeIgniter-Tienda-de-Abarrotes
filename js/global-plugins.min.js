! function ($) {
    ...
    $.fn.fitVids = function (t) {
        ...
        if (!document.getElementById("fit-vids-style")) {
            ...
            a.innerHTML = '<p>x</p><style id="fit-vids-style">' + s + "</style>", i.appendChild(a.childNodes[1])
        }
...
function ($) {
    $.fn.fitText = function (t, e) {
        ...
        return this.each(function () {
            var t = $(this),
                e = function () {
                    t.css("font-size", Math.max(Math.min(t.width() / (10 * i), parseFloat(s.maxFontSize)), parseFloat(s.minFontSize)))
                };
...
function ($) {
    $.flexslider = function (t, e) {
        ...
        var s = i.vars.namespace,
            ...
            n = ("ontouchstart" in window || a || window.DocumentTouch && document instanceof DocumentTouch) && i.vars.touch,
            o = "click touchend MSPointerUp",
            r = "",
            l, h = "vertical" === i.vars.direction,
            u = i.vars.reverse,
            ...
            m = {},
            v = !0;
        $.data(t, "flexslider", i), m = {
            init: function () {
                i.animating = !1, i.currentSlide = parseInt(i.vars.startAt ? i.vars.startAt : 0, 10), isNaN(i.currentSlide) && (i.currentSlide = 0), i.animatingTo = i.currentSlide, i.atEnd = 0 === i.currentSlide || i.currentSlide === i.last, i.containerSelector = i.vars.selector.substr(0, i.vars.selector.search(" ")), i.slides = $(i.vars.selector, i), i.container = $(i.containerSelector, i), i.count = i.slides.length, i.syncExists = $(i.vars.sync).length > 0, "slide" === i.vars.animation && (i.vars.animation = "swing"), i.prop = h ? "top" : "marginLeft", i.args = {}, i.manualPause = !1, i.stopped = !1, i.started = !1, i.startTimeout = null, i.transitions = !i.vars.video && !d && i.vars.useCSS && function () {
                    var t = document.createElement("div"),
                        e = ["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"];
                    for (var s in e)
                        if (void 0 !== t.style[e[s]]) return i.pfx = e[s].replace("Perspective", "").toLowerCase(), i.prop = "-" + i.pfx + "-transform", !0;
                    return !1
                }(), "" !== i.vars.controlsContainer && (i.controlsContainer = $(i.vars.controlsContainer).length > 0 && $(i.vars.controlsContainer)), "" !== i.vars.manualControls && (i.manualControls = $(i.vars.manualControls).length > 0 && $(i.vars.manualControls)), i.vars.randomize && (i.slides.sort(function () {
                    return Math.round(Math.random()) - .5
                }), i.container.empty().append(i.slides)), i.doMath(), i.setup("init"), i.vars.controlNav && m.controlNav.setup(), i.vars.directionNav && m.directionNav.setup(), i.vars.keyboard && (1 === $(i.containerSelector).length || i.vars.multipleKeyboard) && $(document).bind("keyup", function (t) {
                    var e = t.keyCode;
                    if (!i.animating && (39 === e || 37 === e)) {
                        var s = 39 === e ? i.getTarget("next") : 37 === e ? i.getTarget("prev") : !1;
                        i.flexAnimate(s, i.vars.pauseOnAction)
                    }
                }), i.vars.mousewheel && i.bind("mousewheel", function (t, e, s, a) {
                    t.preventDefault();
                ...
                }), i.vars.pauseInvisible && m.pauseInvisible.isHidden() || (i.vars.initDelay > 0 ? i.startTimeout = setTimeout(i.play, i.vars.initDelay) : i.play())), p && m.asNav.setup(), n && i.vars.touch && m.touch(), (!d || d && i.vars.smoothHeight) && $(window).bind("resize orientationchange focus", m.resize), i.find("img").attr("draggable", "false"), setTimeout(function () {
                    i.vars.start(i)
                }, 200)
            },
            asNav: {
                setup: function () {
                    i.asNav = !0, i.animatingTo = Math.floor(i.currentSlide / i.move), i.currentItem = i.currentSlide, i.slides.removeClass(s + "active-slide").eq(i.currentItem).addClass(s + "active-slide"), a ? (t._slider = i, i.slides.each(function () {
                        ...
                        t._gesture = new MSGesture, t._gesture.target = t, t.addEventListener("MSPointerDown", function (t) {
                            ...
                            var e = $(this),
                                s = e.index();
                            $(i.vars.asNavFor).data("flexslider").animating || e.hasClass("active") || (i.direction = i.currentItem < s ? "next" : "prev", i.flexAnimate(s, i.vars.pauseOnAction, !1, !0, !0))
                        })
                        ...
                        0 >= n && e.hasClass(s + "active-slide") ? i.flexAnimate(i.getTarget("prev"), !0) : $(i.vars.asNavFor).data("flexslider").animating || e.hasClass(s + "active-slide") || (i.direction = i.currentItem < a ? "next" : "prev", i.flexAnimate(a, i.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function () {
                    var t = "thumbnails" === i.vars.controlNav ? "control-thumbs" : "control-paging",
                        e = 1,
                        a, n;
                    if (i.controlNavScaffold = $('<ol class="' + s + "control-nav " + s + t + '"></ol>'), i.pagingCount > 1)
                        for (var l = 0; l < i.pagingCount; l++) {
                            if (n = i.slides.eq(l), a = "thumbnails" === i.vars.controlNav ? '<img src="' + n.attr("data-thumb") + '"/>' : "<a>" + e + "</a>", "thumbnails" === i.vars.controlNav && !0 === i.vars.thumbCaptions) {
                                var h = n.attr("data-thumbcaption");
                                "" != h && void 0 != h && (a += '<span class="' + s + 'caption">' + h + "</span>")
                            }
                            i.controlNavScaffold.append("<li>" + a + "</li>"), e++
                        }
                    i.controlsContainer ? $(i.controlsContainer).append(i.controlNavScaffold) : i.append(i.controlNavScaffold), m.controlNav.set(), m.controlNav.active(), i.controlNavScaffold.delegate("a, img", o, function (t) {
                        if (t.preventDefault(), "" === r || r === t.type) {
                            var e = $(this),
                                a = i.controlNav.index(e);
                            e.hasClass(s + "active") || (i.direction = a > i.currentSlide ? "next" : "prev", i.flexAnimate(a, i.vars.pauseOnAction))
                        }
                        "" === r && (r = t.type), m.setToClearWatchedEvent()
                    })
                },
                setupManual: function () {
                    i.controlNav = i.manualControls, m.controlNav.active(), i.controlNav.bind(o, function (t) {
                        if (t.preventDefault(), "" === r || r === t.type) {
                            var e = $(this),
                                a = i.controlNav.index(e);
                            e.hasClass(s + "active") || (i.direction = a > i.currentSlide ? "next" : "prev", i.flexAnimate(a, i.vars.pauseOnAction))
                ...
                set: function () {
                    ...
                    i.controlNav = $("." + s + "control-nav li " + t, i.controlsContainer ? i.controlsContainer : i)
                },
                active: function () {
                    i.controlNav.removeClass(s + "active").eq(i.animatingTo).addClass(s + "active")
                },
                update: function (t, e) {
                    i.pagingCount > 1 && "add" === t ? i.controlNavScaffold.append($("<li><a>" + i.count + "</a></li>")) : 1 === i.pagingCount ? i.controlNavScaffold.find("li").remove() : i.controlNav.eq(e).closest("li").remove(), m.controlNav.set(), i.pagingCount > 1 && i.pagingCount !== i.controlNav.length ? i.update(e, t) : m.controlNav.active()
                }
            },
            directionNav: {
                setup: function () {
                    var t = $('<ul class="' + s + 'direction-nav"><li><a class="' + s + 'prev" href="#">' + i.vars.prevText + '</a></li><li><a class="' + s + 'next" href="#">' + i.vars.nextText + "</a></li></ul>");
                    i.controlsContainer ? ($(i.controlsContainer).append(t), i.directionNav = $("." + s + "direction-nav li a", i.controlsContainer)) : (i.append(t), i.directionNav = $("." + s + "direction-nav li a", i)), m.directionNav.update(), i.directionNav.bind(o, function (t) {
                        t.preventDefault();
                        var e;
                        ("" === r || r === t.type) && (e = i.getTarget($(this).hasClass(s + "next") ? "next" : "prev"), i.flexAnimate(e, i.vars.pauseOnAction)), "" === r && (r = t.type), m.setToClearWatchedEvent()
                    })
                },
                update: function () {
                    var t = s + "disabled";
            ...
            pausePlay: {
                setup: function () {
                    ...
                    i.controlsContainer ? (i.controlsContainer.append(t), i.pausePlay = $("." + s + "pauseplay a", i.controlsContainer)) : (i.append(t), i.pausePlay = $("." + s + "pauseplay a", i)), m.pausePlay.update(i.vars.slideshow ? s + "pause" : s + "play"), i.pausePlay.bind(o, function (t) {
                        t.preventDefault(), ("" === r || r === t.type) && ($(this).hasClass(s + "pause") ? (i.manualPause = !0, i.manualPlay = !1, i.pause()) : (i.manualPause = !1, i.manualPlay = !0, i.play())), "" === r && (r = t.type), m.setToClearWatchedEvent()
                    })
                },
                update: function (t) {
            ...
            touch: function () {
                ...
                function s(t) {
                    b = t.touches[0].pageX, P = t.touches[0].pageY, y = h ? p - P : p - b, _ = h ? Math.abs(y) < Math.abs(b - m) : Math.abs(y) < Math.abs(P - m);
                    var e = 500;
                    (!_ || Number(new Date) - g > e) && (t.preventDefault(), !d && i.transitions && (i.vars.animationLoop || (y /= 0 === i.currentSlide && 0 > y || i.currentSlide === i.last && y > 0 ? Math.abs(y) / f + 2 : 1), i.setProps(v + y, "setTouch")))
                }

                function n(e) {
                    if (t.removeEventListener("touchmove", s, !1), i.animatingTo === i.currentSlide && !_ && null !== y) {
                        var a = u ? -y : y,
                            o = i.getTarget(a > 0 ? "next" : "prev");
                        i.canAdvance(o) && (Number(new Date) - g < 550 && Math.abs(a) > 50 || Math.abs(a) > f / 2) ? i.flexAnimate(o, i.vars.pauseOnAction) : d || i.flexAnimate(i.currentSlide, i.vars.pauseOnAction, !0)
                    }
                    t.removeEventListener("touchend", n, !1), p = null, m = null, y = null, v = null
                }

                function o(e) {
                    e.stopPropagation(), i.animating ? e.preventDefault() : (i.pause(), t._gesture.addPointer(e.pointerId), j = 0, f = h ? i.h : i.w, g = Number(new Date), v = c && u && i.animatingTo === i.last ? 0 : c && u ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : c && i.currentSlide === i.last ? i.limit : c ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : u ? (i.last - i.currentSlide + i.cloneOffset) * f : (i.currentSlide + i.cloneOffset) * f)
                }
                ...
                function r(e) {
                    ...
                    if (i) {
                        var s = -e.translationX,
                            a = -e.translationY;
                        return j += h ? a : s, y = j, _ = h ? Math.abs(j) < Math.abs(-s) : Math.abs(j) < Math.abs(-a), e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            t._gesture.stop()
                        }) : void((!_ || Number(new Date) - g > 500) && (e.preventDefault(), !d && i.transitions && (i.vars.animationLoop || (y = j / (0 === i.currentSlide && 0 > j || i.currentSlide === i.last && j > 0 ? Math.abs(j) / f + 2 : 1)), i.setProps(v + y, "setTouch"))))
                    }
                }
                ...
                function l(t) {
                    ...
                    if (e) {
                        if (e.animatingTo === e.currentSlide && !_ && null !== y) {
                            ...
                            e.canAdvance(s) && (Number(new Date) - g < 550 && Math.abs(i) > 50 || Math.abs(i) > f / 2) ? e.flexAnimate(s, e.vars.pauseOnAction) : d || e.flexAnimate(e.currentSlide, e.vars.pauseOnAction, !0)
                        }
            ...
            resize: function () {
                !i.animating && i.is(":visible") && (c || i.doMath(), d ? m.smoothHeight() : c ? (i.slides.width(i.computedW), i.update(i.pagingCount), i.setProps()) : h ? (i.viewport.height(i.h), i.setProps(i.h, "setTotal")) : (i.vars.smoothHeight && m.smoothHeight(), i.newSlides.width(i.computedW), i.setProps(i.computedW, "setTotal")))
            },
            ...
            pauseInvisible: {
                ...
                init: function () {
                    ...
                    if (m.pauseInvisible.visProp) {
                        var s = m.pauseInvisible.visProp.replace(/[H|h]idden/, "") + "visibilitychange";
            ...
            if (i.vars.animationLoop || t === i.currentSlide || (i.direction = t > i.currentSlide ? "next" : "prev"), p && 1 === i.pagingCount && (i.direction = i.currentItem < t ? "next" : "prev"), !i.animating && (i.canAdvance(t, r) || a) && i.is(":visible")) {
                if (p && o) {
                    var l = $(i.vars.asNavFor).data("flexslider");
                    if (i.atEnd = 0 === t || t === i.count - 1, l.flexAnimate(t, !0, !1, !0, r), i.direction = i.currentItem < t ? "next" : "prev", l.direction = i.direction, Math.ceil((t + 1) / i.visible) - 1 === i.currentSlide || 0 === t) return i.currentItem = t, i.slides.removeClass(s + "active-slide").eq(t).addClass(s + "active-slide"), !1;
                    i.currentItem = t, i.slides.removeClass(s + "active-slide").eq(t).addClass(s + "active-slide"), t = Math.floor(t / i.visible)
                }
                if (i.animating = !0, i.animatingTo = t, e && i.pause(), i.vars.before(i), i.syncExists && !r && m.sync("animate"), i.vars.controlNav && m.controlNav.active(), c || i.slides.removeClass(s + "active-slide").eq(t).addClass(s + "active-slide"), i.atEnd = 0 === t || t === i.last, i.vars.directionNav && m.directionNav.update(), t === i.last && (i.vars.end(i), i.vars.animationLoop || i.pause()), d) n ? (i.slides.eq(i.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), i.slides.eq(t).css({
                    opacity: 1,
            ...
            d || c || (0 === i.currentSlide && i.animatingTo === i.last && i.vars.animationLoop ? i.setProps(t, "jumpEnd") : i.currentSlide === i.last && 0 === i.animatingTo && i.vars.animationLoop && i.setProps(t, "jumpStart")), i.animating = !1, i.currentSlide = i.animatingTo, i.vars.after(i)
            ...
            return e ? !0 : p && i.currentItem === i.count - 1 && 0 === t && "prev" === i.direction ? !0 : p && 0 === i.currentItem && t === i.pagingCount - 1 && "next" !== i.direction ? !1 : t !== i.currentSlide || p ? i.vars.animationLoop ? !0 : i.atEnd && 0 === i.currentSlide && t === s && "next" !== i.direction ? !1 : i.atEnd && i.currentSlide === s && 0 === t && "next" === i.direction ? !1 : !0 : !1
            ...
            var a = function () {
                var s = t ? t : (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo,
                    a = function () {
                        if (c) return "setTouch" === e ? t : u && i.animatingTo === i.last ? 0 : u ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : i.animatingTo === i.last ? i.limit : s;
                        switch (e) {
                            case "setTotal":
            ...
            i.transitions && (a = h ? "translate3d(0," + a + ",0)" : "translate3d(" + a + ",0,0)", s = void 0 !== s ? s / 1e3 + "s" : "0s", i.container.css("-" + i.pfx + "-transition-duration", s), i.container.css("transition-duration", s)), i.args[i.prop] = a, (i.transitions || void 0 === s) && i.container.css(i.args), i.container.css("transform", a)
        }, i.setup = function (t) {
            if (d) i.slides.css({
                width: "100%",
                "float": "left",
                ...
                var e, a;
                "init" === t && (i.viewport = $('<div class="' + s + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(i).append(i.container), i.cloneCount = 0, i.cloneOffset = 0, u && (a = $.makeArray(i.slides).reverse(), i.slides = $(a), i.container.empty().append(i.slides))), i.vars.animationLoop && !c && (i.cloneCount = 2, i.cloneOffset = 1, "init" !== t && i.container.find(".clone").remove(), i.container.append(i.slides.first().clone().addClass("clone").attr("aria-hidden", "true")).prepend(i.slides.last().clone().addClass("clone").attr("aria-hidden", "true")), m.uniqueID(i.slides.first().clone().addClass("clone")).appendTo(i.container), m.uniqueID(i.slides.last().clone().addClass("clone")).prependTo(i.container)), i.newSlides = $(i.vars.selector, i), e = u ? i.count - 1 - i.currentSlide + i.cloneOffset : i.currentSlide + i.cloneOffset, h && !c ? (i.container.height(200 * (i.count + i.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function () {
                    i.newSlides.css({
                        display: "block"
            ...
            c || i.slides.removeClass(s + "active-slide").eq(i.currentSlide).addClass(s + "active-slide"), i.vars.init(i)
        }, i.doMath = function () {
            ...
            i.doMath(), c || (t < i.currentSlide ? i.currentSlide += 1 : t <= i.currentSlide && 0 !== t && (i.currentSlide -= 1), i.animatingTo = i.currentSlide), i.vars.controlNav && !i.manualControls && ("add" === e && !c || i.pagingCount > i.controlNav.length ? m.controlNav.update("add") : ("remove" === e && !c || i.pagingCount < i.controlNav.length) && (c && i.currentSlide > i.last && (i.currentSlide -= 1, i.animatingTo -= 1), m.controlNav.update("remove", i.last))), i.vars.directionNav && m.directionNav.update()
        }, i.addSlide = function (t, e) {
            var s = $(t);
            i.count += 1, i.last = i.count - 1, h && u ? void 0 !== e ? i.slides.eq(i.count - e).after(s) : i.container.prepend(s) : void 0 !== e ? i.slides.eq(e).before(s) : i.container.append(s), i.update(e, "add"), i.slides = $(i.vars.selector + ":not(.clone)", i), i.setup(), i.vars.added(i)
        }, i.removeSlide = function (t) {
            var e = isNaN(t) ? i.slides.index($(t)) : t;
            i.count -= 1, i.last = i.count - 1, isNaN(t) ? $(t, i.slides).remove() : h && u ? i.slides.eq(i.last).remove() : i.slides.eq(t).remove(), i.doMath(), i.update(e, "remove"), i.slides = $(i.vars.selector + ":not(.clone)", i), i.setup(), i.vars.removed(i)
        }, m.init()
        ...
        if (void 0 === t && (t = {}), "object" == typeof t) return this.each(function () {
            var e = $(this),
                ...
                s = e.find(i);
            1 === s.length && t.allowOneSlide === !0 || 0 === s.length ? (s.fadeIn(400), t.start && t.start(e)) : void 0 === e.data("flexslider") && new $.flexslider(this, t)
        });
...
function (t, e) {
    ...
    t.fn.jPlayer = function (i) {
        var s = "string" == typeof i,
            ...
            n = this;
        return i = !s && a.length ? t.extend.apply(null, [!0, i].concat(a)) : i, s && "_" === i.charAt(0) ? n : (this.each(s ? function () {
            var s = t(this).data("jPlayer"),
                o = s && t.isFunction(s[i]) ? s[i].apply(s, a) : s;
            return o !== s && o !== e ? (n = o, !1) : void 0
        } : function () {
            var e = t(this).data("jPlayer");
            e ? e.option(i || {}) : t(this).data("jPlayer", new t.jPlayer(i, this))
        }), n)
    ...
    t.jPlayer.convertTime = function (t) {
        ...
        var e = /(opera)(?:.*version)?[ \/]([\w.]+)/,
            i = /(msie) ([\w.]+)/,
            s = /(mozilla)(?:.*? rv:([\w.]+))?/;
        return t = /(webkit)[ \/]([\w.]+)/.exec(t) || e.exec(t) || i.exec(t) || 0 > t.indexOf("compatible") && s.exec(t) || [], {
            browser: t[1] || "",
            version: t[2] || "0"
        }
        ...
        var e = t.toLowerCase(),
            i = /(android)/,
            s = /(mobile)/;
        return t = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/.exec(e) || [], e = /(ipad|playbook)/.exec(e) || !s.exec(e) && i.exec(e) || [], t[1] && (t[1] = t[1].replace(/\s/g, "_")), {
            platform: t[1] || "",
            tablet: e[1] || ""
        }
    }, t.jPlayer.browser = {}, t.jPlayer.platform = {};
    var a = t.jPlayer.uaBrowser(navigator.userAgent);
    a.browser && (t.jPlayer.browser[a.browser] = !0, t.jPlayer.browser.version = a.version), a = t.jPlayer.uaPlatform(navigator.userAgent), a.platform && (t.jPlayer.platform[a.platform] = !0, t.jPlayer.platform.mobile = !a.tablet, t.jPlayer.platform.tablet = !!a.tablet), t.jPlayer.getDocMode = function () {
        var e;
    ...
    t.jPlayer.keys = function (e) {
        t(document.documentElement).unbind("keydown.jPlayer"), e && t(document.documentElement).bind("keydown.jPlayer", n)
            ...
            if (this.element.empty(), this.status = t.extend({}, this.status), this.internal = t.extend({}, this.internal), this.options.timeFormat = t.extend({}, t.jPlayer.timeFormat, this.options.timeFormat), this.internal.cmdsIgnored = t.jPlayer.platform.ipad || t.jPlayer.platform.iphone || t.jPlayer.platform.ipod, this.internal.domNode = this.element.get(0), this.options.keyEnabled && !t.jPlayer.focus && (t.jPlayer.focus = this), this.formats = [], this.solutions = [], this.require = {}, this.htmlElement = {}, this.html = {}, this.html.audio = {}, this.html.video = {}, this.flash = {}, this.css = {}, this.css.cs = {}, this.css.jq = {}, this.ancestorJq = [], this.options.volume = this._limitValue(this.options.volume, 0, 1), t.each(this.options.supplied.toLowerCase().split(","), function (e, s) {
                    ...
                    if (0 === e) i[s].desired = !0;
                        ...
                        var a = !1,
                            n = !1;
                        t.each(i.formats, function (t, e) {
                            i[i.solutions[0]].canPlay[e] && ("video" === i.format[e].media ? n = !0 : a = !0)
        ...
        _addHtmlEventListeners: function (e, i) {
            ...
            e.preload = this.options.preload, e.muted = this.options.muted, e.volume = this.options.volume, this.status.playbackRateEnabled && (e.defaultPlaybackRate = this.options.defaultPlaybackRate, e.playbackRate = this.options.playbackRate), e.addEventListener("progress", function () {
                i.gate && (s.internal.cmdsIgnored && 0 < this.readyState && (s.internal.cmdsIgnored = !1), s._getHtmlStatus(e), s._updateInterface(), s._trigger(t.jPlayer.event.progress))
        ...
        _getHtmlStatus: function (t, e) {
            var i = 0,
                ...
                a = 0,
                n = 0;
            isFinite(t.duration) && (this.status.duration = t.duration), i = t.currentTime, s = 0 < this.status.duration ? 100 * i / this.status.duration : 0, "object" == typeof t.seekable && 0 < t.seekable.length ? (a = 0 < this.status.duration ? 100 * t.seekable.end(t.seekable.length - 1) / this.status.duration : 100, n = 0 < this.status.duration ? 100 * t.currentTime / t.seekable.end(t.seekable.length - 1) : 0) : (a = 100, n = s), e && (s = n = i = 0), this.status.seekPercent = a, this.status.currentPercentRelative = n, this.status.currentPercentAbsolute = s, this.status.currentTime = i, this.status.videoWidth = t.videoWidth, this.status.videoHeight = t.videoHeight, this.status.readyState = t.readyState, this.status.networkState = t.networkState, this.status.playbackRate = t.playbackRate, this.status.ended = t.ended
        },
        _resetStatus: function () {
            this.status = t.extend({}, this.status, t.jPlayer.prototype.status)
        },
        _trigger: function (e, i, s) {
            e = t.Event(e), e.jPlayer = {}, e.jPlayer.version = t.extend({}, this.version), e.jPlayer.options = t.extend(!0, {}, this.options), e.jPlayer.status = t.extend(!0, {}, this.status), e.jPlayer.html = t.extend(!0, {}, this.html), e.jPlayer.flash = t.extend(!0, {}, this.flash), i && (e.jPlayer.error = t.extend({}, i)), s && (e.jPlayer.warning = t.extend({}, s)), this.element.trigger(e)
        },
        ...
        setMedia: function (e) {
            ...
            this._resetMedia(), this._resetGate(), this._resetActive(), e = this._absoluteMediaUrls(e), t.each(this.formats, function (a, n) {
                ...
                return t.each(i.solutions, function (t, a) {
            ...
            }), s ? (this.status.nativeVideoControls && this.html.video.gate || !this._validString(e.poster) || (a ? this.htmlElement.poster.src = e.poster : this.internal.poster.jq.show()), this.status.srcSet = !0, this.status.media = t.extend({}, e), this._updateButtons(!1), this._updateInterface()) : this._error({
        ...
        tellOthers: function (e, i) {
            ...
            "string" == typeof e && (a && n.splice(1, 1), t.each(this.instances, function () {
                s.element !== this && (a && !i.call(this.data("jPlayer"), s) || this.jPlayer.apply(this, n))
            }))
        },
        ...
        volumeBar: function (e) {
            if (this.css.jq.volumeBar.length) {
                var i = t(e.currentTarget),
                    ...
                    a = e.pageX - s.left,
                    n = i.width();
                e = i.height() - e.pageY + s.top, i = i.height(), this.volume(this.options.verticalVolume ? e / i : a / n)
            }
        ...
        _cssSelector: function (e, i) {
            var s = this;
            "string" == typeof i ? t.jPlayer.prototype.options.cssSelector[e] ? (this.css.jq[e] && this.css.jq[e].length && this.css.jq[e].unbind(".jPlayer"), this.options.cssSelector[e] = i, this.css.cs[e] = this.options.cssSelectorAncestor + " " + i, this.css.jq[e] = i ? t(this.css.cs[e]) : [], this.css.jq[e].length && this.css.jq[e].bind("click.jPlayer", function (i) {
        ...
        seekBar: function (e) {
            if (this.css.jq.seekBar.length) {
                var i = t(e.currentTarget),
                    s = i.offset();
                e = e.pageX - s.left, i = i.width(), this.playHead(100 * e / i)
            }
        },
        playBar: function () {},
        ...
        playbackRateBar: function (e) {
            if (this.css.jq.playbackRateBar.length) {
                var i = t(e.currentTarget),
                    ...
                    a = e.pageX - s.left,
                    n = i.width();
                e = i.height() - e.pageY + s.top, i = i.height(), this.playbackRate((this.options.verticalPlaybackRate ? e / i : a / n) * (this.options.maxPlaybackRate - this.options.minPlaybackRate) + this.options.minPlaybackRate)
            }
        },
        ...
        option: function (i, s) {
            ...
            if ("string" == typeof i) {
                var n = i.split(".");
                if (s === e) {
                    for (var a = t.extend(!0, {}, this.options), o = 0; o < n.length; o++) {
                        if (a[n[o]] === e) return this._warning({
        ...
        _exitFullscreen: function () {
            var e = t.jPlayer.nativeFeatures.fullscreen,
                i;
            e.used.webkitVideo && (i = this.htmlElement.video), e.api.fullscreenEnabled && e.api.exitFullscreen(i)
        },
        ...
        _getFlashPluginVersion: function () {
            ...
            } catch (s) {} else navigator.plugins && 0 < navigator.mimeTypes.length && (e = navigator.plugins["Shockwave Flash"]) && (t = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/, "$1"));
            return 1 * t
        },
        ...
        _emulateHtmlBridge: function () {
            ...
            t.each(t.jPlayer.emulateMethods.split(/\s+/g), function (t, i) {
                ...
                }), a && e.element.bind(s + ".jPlayer.jPlayerHtml", function () {
        ...
        _destroyHtmlBridge: function () {
            var e = this;
            this.element.unbind(".jPlayerHtml"), t.each((t.jPlayer.emulateMethods + " " + t.jPlayer.emulateStatus + " " + t.jPlayer.emulateOptions).split(/\s+/g), function (t, i) {
